...
Run AppleScript to determine if a file should be excluded.

<Warning>
  Custom scripts are **not implemented** in the current version. This is a placeholder for future functionality.
</Warning>
